...
| 11 | [apps/11-employee-communication-data.md](apps/11-employee-communication-data.md) | **Employee Communication Data** (`ZHCM_ECD_REQ`) | RAP transactional Fiori app (employee) + approval workflow |

*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZHCM_RULE_MV
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZHCM_RULE_MV        .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZHCM_RULE_MV'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZHCM_RULE_MV_EXTRACT
TOTAL = ZHCM_RULE_MV_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZHCM_RULE_MV'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZHCM_RULE_MV-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZHCM_RULE_MV_EXTRACT
TOTAL = ZHCM_RULE_MV_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZHCM_RULE_MV-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZHCM_RULE_MV'
...
TOTAL = ZHCM_RULE_MV_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZHCM_RULE_MV-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZHCM_RULE_MV-UPD_FLAG NE SPACE.
